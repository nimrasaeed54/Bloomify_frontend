...
//         }`}>
//           <button className="bg-white text-gray-800 px-4 py-2 rounded-full flex items-center font-medium hover:bg-gray-50 transition-colors">
...
//               <span className="ml-2 text-sm text-gray-500 line-through">Rs {product.originalPrice}</span>
//             )}
//           </div>
//           <button className="bg-[#A3C9A8] hover:bg-[#9dc9a3] text-black px-4 py-2 rounded-lg flex items-center transition-colors font-medium">
